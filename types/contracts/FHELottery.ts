...
export interface FHELotteryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "admin"
      | "buyTicket"
...
export interface FHELottery extends BaseContract {
  connect(runner?: ContractRunner | null): FHELottery;
  waitForDeployment(): Promise<this>;

  interface: FHELotteryInterface;
  ...
  buyTicket: TypedContractMethod<
    [roundId: BigNumberish, number: BytesLike, proof: BytesLike],
    [void],
    "nonpayable"
  >;
  ...
  draw: TypedContractMethod<
    [roundId: BigNumberish, plainWinningNumber: BigNumberish],
    [void],
    "nonpayable"
  >;
